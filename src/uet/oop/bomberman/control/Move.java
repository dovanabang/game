...
public class Move {
    ...
    public static void checkMove(LifesInGame lifes) {
        ...
        if ((lifes instanceof Ballom ||lifes instanceof Doll)  && lifes.getCountStep() > 0) {
    ...
    public static void Down(LifesInGame lifes) {
        if (lifes.getY() % 32 == 0 && lifes.getX() % 32 == 0) {
            ...
            if ((lifes instanceof Ballom ||lifes instanceof Doll) && Collision.canMove(lifes.getX(), lifes.getY() + 1)) {
                lifes.setDirect("down");
                lifes.setCountStep(4/speed);
                checkMove(lifes);
            }
    ...
    public static void Left(LifesInGame lifes) {
        if (lifes.getY() % 32 == 0 && lifes.getX() % 32 == 0) {
            ...
            if ((lifes instanceof Ballom ||lifes instanceof Doll) && Collision.canMove(lifes.getX() - 1, lifes.getY())) {
                lifes.setDirect("left");
                lifes.setCountStep(4/speed);
                checkMove(lifes);
            }
